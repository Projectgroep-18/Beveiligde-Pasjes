...
c.execute("""INSERT INTO persoon VALUES (4, 255970565998217052893709, 'Jeroen Weener', 1, 'Aan')""")
...
c.execute("""INSERT INTO persoon VALUES (7, 237118211425339845326898, 'Menno Schober', 1, 'Aan')""")
